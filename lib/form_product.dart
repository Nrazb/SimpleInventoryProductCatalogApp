...
class FormProduct extends StatefulWidget {
  final Product? product; // null = Add, ada isi = Edit
...
class _FormProductState extends State<FormProduct> {
  ...
  String? _validateUrl(String? v) {
    final value = (v ?? '').trim();
    if (value.isEmpty) return null; // opsional
  ...
  void _submit() {
    ...
    final imageUrl = url.isEmpty ? null : url;
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) {
                  ...
                  if (value == null) return 'Quantity must be a whole number';
